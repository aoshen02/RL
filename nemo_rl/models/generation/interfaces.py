...
class GenerationServerGroupConfig(TypedDict):
    """One colocated vLLM server group used by rollout-only NeMo-Gym runs."""
...
class GenerationConfig(TypedDict):
    ...
    server_groups: NotRequired[list[GenerationServerGroupConfig]]
