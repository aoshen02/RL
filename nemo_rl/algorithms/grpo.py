...
class AsyncGRPOConfig(TypedDict):
    ...
    # Maximum consecutive generation-worker failures the
    # AsyncTrajectoryCollector tolerates before aborting the run. A successful
...
def async_grpo_train(
    ...
    try:
        ...
        raise KeyError(
            "grpo.async_grpo.max_generation_failures is required for async GRPO"
        ) from error
